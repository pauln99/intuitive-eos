...
| Before (too wordy) | After (binary) |
|---|---|
| Month-end financials completed by 10th, adjustments <5% budget EBITDA, reporting suite built with P&L vs budget vs reforecast, delta analysis, monthly FY reforecast | New finance system live and processing all revenue |
| Improve customer satisfaction and build a new feedback process with quarterly reviews | Customer NPS hits 50 |
